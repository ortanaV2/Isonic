...
/* Real TI SN74HC32N pinout (Quad 2-Input OR Gate) - same physical 14-pin DIP
   layout as its SN74HC08N (AND) family sibling: pins 1-7 down the left side,
   ...
   pin_number i+1). */
static const IC_PinDef k_sn74hc32_pins[14] = {
...
static const IC_Def k_sn74hc32_def = {
    .name = "SN74HC32N",
    .pin_count = 14,
    .pins = k_sn74hc32_pins,
    .eval = sn74hc32_eval,
};

void ic_sn74hc32_register(void) {
    ic_registry_register(&k_sn74hc32_def);
}
